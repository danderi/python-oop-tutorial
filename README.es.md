...
- **Calificado**: Sí
- Vista previa disponible en: [Vista previa del tutorial](https://github.com/4GeeksAcademy/python-oop-tutorial/blob/main/preview.gif?raw=true)

¿Encontraste un error? Repórtalo [aquí](https://github.com/learnpack/learnpack/issues/new)
...
```bash
$ git clone https://github.com/4GeeksAcademy/python-oop-tutorial
